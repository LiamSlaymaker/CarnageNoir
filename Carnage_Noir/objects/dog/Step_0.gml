...
{
	var j = 0;
	while j<4 and intersection(x,y,last_seen_x,last_seen_y,8)>0
	{
	last_seen_x=player.x+lengthdir_x(64,90*j)
	last_seen_y=player.y+lengthdir_y(64,90*j)
	j+=1
	show_debug_message("DOG BUG");
	}
active=0 
alarm[0]=120
exit
